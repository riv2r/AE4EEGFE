            ...
            for targetState3=1:2
                for targetState4=1:2
                    for targetState5=1:2
                        ...
                        screenMatrix{textureNumber}=targetMatrix{6} | targetMatrix{1}*uint8(targetState1-1) | targetMatrix{2}*uint8(targetState2-1) |...
                                                    targetMatrix{3}*uint8(targetState3-1) | targetMatrix{4}*uint8(targetState4-1) | targetMatrix{5}*uint8(targetState5-1);
                    end
                end
            end
        end
